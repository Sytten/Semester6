...
/* CAPACITE LOCAL */
ALTER TABLE locaux DROP CONSTRAINT IF EXISTS positive_cap;
ALTER TABLE locaux ADD CONSTRAINT positive_cap CHECK(capacite > 0);
...
ALTER TABLE membres DROP CONSTRAINT IF EXISTS not_empty_cip;
ALTER TABLE membres ADD CONSTRAINT not_empty_cip CHECK(NOT empty(cip));
